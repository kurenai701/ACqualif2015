...
public class MockTestGenerator {
	...
	public ServerAllocation[] getServerAllocationTest()
	{
		...
		serverAllocation[0] = new ServerAllocation(0, 0, 1, 0);
		serverAllocation[1] = new ServerAllocation(1, 1, 0, 1);
		serverAllocation[2] = new ServerAllocation(2, 1, 3, 0);
		serverAllocation[3] = new ServerAllocation(3, 0, 4, 1);
		serverAllocation[4] = new ServerAllocation(4, -1, 42, 42);
